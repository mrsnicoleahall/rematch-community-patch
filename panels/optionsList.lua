...
rematch.optionsList = {
	...
	-- [Community fix] read version from our addon (Rematch_Community) when the original is disabled
	{type="text", group=20, text=L["Version "]..(C_AddOns.GetAddOnMetadata("Rematch_Community","Version") or C_AddOns.GetAddOnMetadata("Rematch","Version") or "")},
