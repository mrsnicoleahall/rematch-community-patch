...
local defaults = {
    ...
    UseTypeBar = true, -- [Community fix] default the typebar to visible — the quick-access pet-type / Strong Vs / Tough Vs row is genuinely useful and most users want it on. Toggle via the small arrow in the top-left of the pet panel.
